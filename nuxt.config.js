...
export default {
  env: {
    ...
    storeId:
      process.env.NODE_ENV === "development"
        ? process.env.STORE_ID_DEV
        : process.env.STORE_ID_PROD,
    s3Url:
      process.env.NODE_ENV === "development"
        ? process.env.S3_URL_DEV
        : process.env.S3_URL_PROD,
  },
  ssr: true,
  target: "static",
  ...
  head: {
    ...
    link: [
      ...
      { rel: "icon", type: "image/png", href: "/LogoTop.png" },
      {
        rel: "stylesheet",
        href:
      ...
      },
      {
        rel: "stylesheet",
        href:
          "https://fonts.googleapis.com/css2?family=Acme&family=Balsamiq+Sans:ital,wght@1,700&family=Fira+Sans+Condensed:wght@500&display=swap",
      },
      {
        rel: "stylesheet",
        href:
      ...
      },
      {
        rel: "stylesheet",
        href:
          "https://fonts.googleapis.com/css2?family=Lobster&family=Open+Sans:wght@400;500&family=Pacifico&family=Roboto&display=swap",
      },
    ],
  },
